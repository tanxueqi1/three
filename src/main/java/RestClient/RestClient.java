...
public class RestClient {
   ...
   * @throws IOException
   */
  public CloseableHttpResponse put(String url, HashMap<String, String> headerMap, String entityString) throws ClientProtocolException, IOException {
  ...
  public int getStatusCode(CloseableHttpResponse response) {
    ...
    Log.info("解析，得到响应状态码:" + httpStatusCode);
   ...
   * @return， 返回响应体的json格式对象，方便接下来对JSON对象内容解析 接下来，一般会继续调用TestUtil类下的json解析方法得到某一个json对象的值
   * @throws ParseException
   * @throws IOException
   */
  public String getResponseEntity(CloseableHttpResponse response) throws ParseException, IOException {
