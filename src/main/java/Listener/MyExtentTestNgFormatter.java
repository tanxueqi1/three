...
public class MyExtentTestNgFormatter extends ExtentTestNgFormatter {
  ...
  /**
   * Adds the new node to the test. The node name should have been set already using
   * {@link NodeName}
   */
  ...
  /**
   * Adds a info log message to the node. The node name should have been set already using
   * {@link NodeName}
   *
